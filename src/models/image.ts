...
export async function deoldifyImage(url: string): Promise<string> {
...
export async function faceRestoration(url: string): Promise<string> {
	return await runReplicateModel(
...
export async function deblur(url: string): Promise<string> {
	return await runReplicateModel(
